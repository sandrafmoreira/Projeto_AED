...
#       Criar uma listbox para mostrar os users
        ...
        lines = f.readlines()        
        self.lbox_users= Listbox(self.tl, height=10, selectmode='single', font=('Roboto', 14))
        for line in lines:
...
#       Criar um botãozinho para chamar a função de remover o user
        self.btn_remove_user = Button(self.tl, text='Trash account', bg= '#ccc', fg='white', border = '0', padx=5, pady=5, font=('Roboto', 14), command=self.remove_account)
